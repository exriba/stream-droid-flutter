...
import '../common/redeem.pb.dart' as $2;
...
class UserRedeemResponse extends $pb.GeneratedMessage {
  factory UserRedeemResponse({
    $core.Iterable<$2.UserRedeem>? userRedeems,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pPM<$2.UserRedeem>(1, _omitFieldNames ? '' : 'userRedeems',
        subBuilder: $2.UserRedeem.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$2.UserRedeem> get userRedeems => $_getList(0);
}

class RewardRedeemResponse extends $pb.GeneratedMessage {
  factory RewardRedeemResponse({
    $core.Iterable<$2.RewardRedeem>? rewardRedeems,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pPM<$2.RewardRedeem>(1, _omitFieldNames ? '' : 'rewardRedeems',
        subBuilder: $2.RewardRedeem.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$2.RewardRedeem> get rewardRedeems => $_getList(0);
}
